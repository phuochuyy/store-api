    ...
    class DiscountsController < Api::V1::BaseController
      ...
      def create
        ...
        if result[:success]
          ...
          render_error('Discount could not be created', :unprocessable_content, result[:errors])
        end
      end
      ...
      def update
        ...
        if result[:success]
          ...
          render_error('Discount could not be updated', :unprocessable_content, result[:errors])
        end
      end
