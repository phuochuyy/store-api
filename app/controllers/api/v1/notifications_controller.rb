    ...
    class NotificationsController < Api::V1::BaseController
      ...
      def update
        ...
        if @notification.update(update_params)
          ...
          render_error('Failed to update notification', :unprocessable_content, @notification.errors.full_messages)
        end
      end
      ...
      def destroy
        if @notification.destroy
          ...
          render_error('Failed to delete notification', :unprocessable_content, @notification.errors.full_messages)
        end
      end
